...
#define SELECT_BACK         -5
#define SELECT_LEFT         -6
#define SELECT_RIGHT        -7

#define ITEM_REBOOT          0
#define ITEM_UMS_TOGGLE      1
#define ITEM_APPLY_SDCARD    2
#define ITEM_APPLY_SPLASH    3
#define ITEM_BROWSE_UPDATE   4
#define ITEM_BROWSE_SPLASH   5
